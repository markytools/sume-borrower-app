...
QT_MOC_LITERAL(1, 10, 21), // "on_addSubject_clicked"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 24), // "on_deleteSubject_clicked"
QT_MOC_LITERAL(4, 58, 15), // "on_Back_clicked"
QT_MOC_LITERAL(5, 74, 22) // "on_editSubject_clicked"

    },
    "SubjectUI\0on_addSubject_clicked\0\0"
    "on_deleteSubject_clicked\0on_Back_clicked\0"
    "on_editSubject_clicked"
};
...
void SubjectUI::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        SubjectUI *_t = static_cast<SubjectUI *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->on_addSubject_clicked(); break;
        case 1: _t->on_deleteSubject_clicked(); break;
        case 2: _t->on_Back_clicked(); break;
        case 3: _t->on_editSubject_clicked(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
void *SubjectUI::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "CustomQtUI"))
        return static_cast< CustomQtUI*>(const_cast< SubjectUI*>(this));
